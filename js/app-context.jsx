...
window.AppProvider = ({ children }) => {
    ...
    return <window.AppContext.Provider value={value}>{children}</window.AppContext.Provider>;
};

window.Button = ({ onClick, children, variant = 'primary', className = '', ...props }) => {
...
window.Modal = ({ title, onClose, children, icon: Icon, footer }) => (
